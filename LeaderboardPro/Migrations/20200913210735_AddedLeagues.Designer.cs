...
namespace LeaderboardPro.Migrations
{
    ...
    [Migration("20200913210735_AddedLeagues")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LeaderboardPro.Data.Division", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("LeaderboardPro.Data.League", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<int>("NoOfPromotedPlayers")
                        .HasColumnType("int");

                    b.Property<int>("NoOfRelegatedPlayers")
                        .HasColumnType("int");

                    b.Property<int>("PointsPerTie")
                        .HasColumnType("int");

                    b.Property<int>("PointsPerWin")
                        .HasColumnType("int");

                    b.Property<bool>("SortDivisionsAscending")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("LeaderboardPro.Data.PlayersInDivision", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("LeaderboardPro.Data.TeamDivision", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("LeaderboardPro.Data.TeamLeague", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<int>("NoOfPromotedTeams")
                        .HasColumnType("int");

                    b.Property<int>("NoOfRelegatedTeams")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LeaderboardPro.Data.TeamsInTeamDivision", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<long>("TeamDivisionId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("TeamDivisionId");

                    b.HasIndex("TeamId");

                    b.ToTable("TeamsInTeamDivisions");
                });
            ...
            modelBuilder.Entity("LeaderboardPro.Data.Tournament", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("LeaderboardPro.Data.TournamentType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("LeaderboardPro.Data.Division", b =>
                {
                    b.HasOne("LeaderboardPro.Data.League", "League")
                        .WithMany("Divisions")
            ...
            modelBuilder.Entity("LeaderboardPro.Data.PlayersInDivision", b =>
                {
                    b.HasOne("LeaderboardPro.Data.Division", "Division")
                        .WithMany()
            ...
            modelBuilder.Entity("LeaderboardPro.Data.TeamDivision", b =>
                {
                    b.HasOne("LeaderboardPro.Data.TeamLeague", "TeamLeague")
                        .WithMany()
            ...
            modelBuilder.Entity("LeaderboardPro.Data.TeamsInTeamDivision", b =>
                {
                    b.HasOne("LeaderboardPro.Data.TeamDivision", "TeamDivision")
                        .WithMany()
                        .HasForeignKey("TeamDivisionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("LeaderboardPro.Data.Tournament", b =>
                {
                    b.HasOne("LeaderboardPro.Data.GameMode", "GameMode")
                        .WithMany()
                        .HasForeignKey("GameModeId1");

                    b.HasOne("LeaderboardPro.Data.TournamentType", "TournamentType")
                        .WithMany()
